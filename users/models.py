...
ORDINARY_USERS, MANAGER, ADMIN = ("ordinary_users", "manager", "admin")
...
class User(AbstractUser, BaseModel):
    ...
    user_role = models.CharField(max_length=31, choices=USER_ROLES, default=ORDINARY_USERS)
    ...
    photo = models.ImageField(upload_to='user_photos/', null=True, blank=True,
                              validators=[
                                  FileExtensionValidator(allowed_extensions=['jpg', 'jpeg', 'png', 'gif', 'heic'])])
