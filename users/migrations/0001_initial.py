    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_role', models.CharField(choices=[('ordinary_users', 'ordinary_users'), ('manager', 'manager'), ('admin', 'admin')], default='ordinary_users', max_length=31)),
                ...
                ('photo', models.ImageField(blank=True, null=True, upload_to='user_photos/', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['jpg', 'jpeg', 'png', 'gif', 'heic'])])),
